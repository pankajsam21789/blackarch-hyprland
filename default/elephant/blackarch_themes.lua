--
-- Dynamic Blackarch Theme Menu for Elephant/Walker
--
Name = "blackarchthemes"
NamePretty = "Blackarch Themes"

-- The main function elephant will call
function GetEntries()
  local entries = {}
  local theme_dir = os.getenv("HOME") .. "/.config/blackarch/themes"
    ...
    if theme_name then
      ...
      if preview_path and preview_path ~= "" then
        ...
        table.insert(entries, {
          ...
          PreviewType = "file",
          Actions = {
            activate = "blackarch-theme-set " .. theme_name,
          },
        })
      end
    end
